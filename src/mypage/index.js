...
function IndexPage() {
  ...
  function Profile() {
    return (
      <table id="profile-table">
        ...
        <tr>
            <td colSpan="2" id="profile-table-info">{mypage_info.name}</td>
        </tr>
        <tr>
            <td colSpan="2" id="profile-table-info">{mypage_info.email}</td>
        </tr>
        <tr>
            <td colSpan="2" id="profile-table-info">{mypage_info.birth}</td>
        </tr>
        <tr>
            <td colSpan="2" id="profile-table-info">{mypage_info.sex}</td>
        </tr>
        <tr>
          <td id="profile-table-info-iot">IOT 신청여부 :&nbsp;{mypage_info.iot}</td>
  ...
  function MyPost() {
    return (
      <div id="mypost-div">
        <List
          style={{backgroundColor:'#fff', padding:'20px', borderRadius:'30px'}}
          itemLayout="vertical"
          size="large"
          pagination={{
            onChange: page => {
